...
from .forms import RegistrationForm  # Relative import corrected
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if cd['password'] == cd['confirm_password']:
                ...
                message = render_to_string('poll/registration_email.html', {'user': obj})
                plain_message = strip_tags(message)
                to_email = obj.email  # Assuming you have an email field in your registration model
                send_mail(subject, plain_message, settings.DEFAULT_FROM_EMAIL, [to_email], html_message=message)
